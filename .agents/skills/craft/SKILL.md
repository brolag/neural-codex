...
This skill is the build orchestrator. The separate `/prompts:neural.craft` command remains the legacy **Context, Requirements, Actions, Flow, Tests** YAML builder.
